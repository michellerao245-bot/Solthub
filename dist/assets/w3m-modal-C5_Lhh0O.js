import{dY as k,eo as le,cP as c,cR as pe,cB as v,cC as V,cF as f,cG as g,cH as d,cE as l,dc as $,c_ as H,dd as u,cD as me,cW as w,cJ as B,da as U,ek as fe,e2 as F,cT as K,dS as A,d2 as M,cM as we,cQ as E,d_ as z,eh as oe,db as be,cL as ce,ep as ge,eq as ye}from"./index-odtpEewF.js";import{P as D}from"./index-ceDXrNxS.js";import{S as ve}from"./SwapController-CV8syWXi.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
