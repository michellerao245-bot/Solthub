...
function tonelliShanks(P2) {
  ...
  return function tonelliSlow(Fp3, n2) {
    ...
    while (!Fp3.eql(b2, Fp3.ONE)) {
      ...
      const ge = Fp3.pow(g2, _1n2 << BigInt(r4 - m2 - 1));
      g2 = Fp3.sqr(ge);
      x2 = Fp3.mul(x2, ge);
      b2 = Fp3.mul(b2, g2);
      r4 = m2;
...
function weierstrass(curveDef) {
  ...
  function prepSig(msgHash, privateKey, opts = defaultSigOpts) {
    ...
    function k2sig(kBytes) {
      ...
      if (s3 === _0n4)
        return;
      let recovery = (q2.x === r4 ? 0 : 2) | Number(q2.y & _1n4);
      let normS = s3;
...
function sign5(options) {
  const { extraEntropy: extraEntropy2 = extraEntropy, hash: hash9, payload, privateKey } = options;
  const { r: r4, s: s3, recovery } = secp256k1.sign(from(payload), from(privateKey), {
    extraEntropy: typeof extraEntropy2 === "boolean" ? extraEntropy2 : from2(extraEntropy2).slice(2),
    lowS: true,
    ...hash9 ? { prehash: true } : {}
  });
...
@noble/curves/esm/bls12-381.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-X7XJDXTR.js.map
