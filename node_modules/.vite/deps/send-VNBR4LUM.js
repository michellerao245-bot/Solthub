import "./chunk-ZZUENAEK.js";
import "./chunk-GOKPREO2.js";
    ...
    return html` <wui-flex flexDirection="column" .padding=${["0", "4", "4", "4"]}>
      <wui-flex gap="2" flexDirection="column" .padding=${["0", "2", "0", "2"]}>
        <wui-flex alignItems="center" justifyContent="space-between">
          ...
          <wui-preview-item
            text="${this.sendTokenAmount ? UiHelperUtil.roundNumber(Number(this.sendTokenAmount), 6, 5) : "unknown"} ${(_a = this.token) == null ? void 0 : _a.symbol}"
...
//# sourceMappingURL=send-VNBR4LUM.js.map
