import{cA as D,dc as l,cD as m,cE as C,cF as L,cV as S,cM as d,cG as u,c$ as V,cS as N,cO as P,cX as F,dX as M,cT as K,cU as Q,cB as W,cC as q,ek as _}from"./index-BDsXA-9J.js";import{S as r}from"./SwapController-CuVP0Rev.js";import"./index-BzjHJQDt.js";const G={numericInputKeyDown(e,t,o){const i=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=e.metaKey||e.ctrlKey,n=e.key,a=n.toLocaleLowerCase(),c=a==="a",x=a==="c",$=a==="v",E=a==="x",A=n===",",R=n===".",B=n>="0"&&n<="9";!s&&(c||x||$||E)&&e.preventDefault(),t==="0"&&!A&&!R&&n==="0"&&e.preventDefault(),t==="0"&&B&&(o(n),e.preventDefault()),(A||R)&&(t||(o("0."),e.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&e.preventDefault()),!B&&!i.includes(n)&&!R&&!A&&e.preventDefault()}},H=D`
  :host {
    width: 100%;
  }
