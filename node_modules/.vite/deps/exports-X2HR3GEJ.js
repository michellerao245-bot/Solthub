...
import {
  ...
  randomPrivateKey,
  sign2 as sign
} from "./chunk-25OTH7T3.js";
import {
  ctr
} from "./chunk-DH2S55CW.js";
import {
  HDKey,
  generateMnemonic,
  mnemonicToSeedSync,
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await (() => {
          try {
            return import("./dist-FP7GXDUH.js");
          } catch {
    ...
    async getProvider() {
      if (!walletProvider) {
        const { createCoinbaseWalletSDK } = await (() => {
          try {
            return import("./dist-DWNW2K3R.js");
          } catch {
      ...
      if (!provider_) {
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await (() => {
            try {
              return import("./dist-WMQLQQWX.js");
            } catch {
...
@noble/curves/esm/ed25519.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=exports-X2HR3GEJ.js.map
