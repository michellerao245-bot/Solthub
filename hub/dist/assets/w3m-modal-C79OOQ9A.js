import{dX as k,en as le,cO as c,cQ as pe,cA as v,cB as V,cE as f,cF as g,cG as d,cD as l,db as $,cZ as H,dc as u,cC as me,cV as w,cI as B,d9 as U,ej as fe,e1 as F,cS as K,dR as A,d1 as M,cL as we,cP as E,dZ as z,eg as oe,da as be,cK as ce,eo as ge,ep as ye}from"./index-BDsXA-9J.js";import{P as D}from"./index-DqV3e9F9.js";import{S as ve}from"./SwapController-CuVP0Rev.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
