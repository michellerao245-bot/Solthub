...
(function(transfer4) {
  async function inner(action, client, parameters) {
    ...
    const call2 = transfer4.call({ amount, from: from24, memo, token, to: to2 });
    return await action(client, {
      ...rest,
      ...call2
    });
  }
  transfer4.inner = inner;
  function call(args) {
  ...
  transfer4.extractEvent = extractEvent;
})(transfer || (transfer = {}));
...
async function send(config, parameters = {}) {
  ...
  return actions_exports.wallet.send(client, rest);
}
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await (() => {
          try {
            return import("./dist-D7VV5NHJ.js");
          } catch {
      ...
      if (!provider_) {
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await (() => {
            try {
              return import("./dist-VURRT3YC.js");
            } catch {
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        const { EthereumProvider } = await (() => {
          try {
            return import("./dist-66OYUUBO.js");
          } catch {
...
@noble/curves/esm/ed25519.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=exports-UJDGDXLR.js.map
