import{a_ as k,bk as le,bh as c,R as pe,cK as v,f2 as V,cM as f,ec as g,c8 as d,ex as l,eE as $,s as H,eX as u,c$ as me,J as w,fX as B,w as U,v as fe,X as F,ac as K,b6 as A,S as M,ed as we,br as E,t as z,aj as oe,bx as be,bG as ce,ef as ge,r as ye}from"./index-yiLPzmeq.js";import{P as D}from"./index-zInH5K5M.js";import{S as ve}from"./SwapController-CQFXleMm.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
